              ...
              <ProjectSectionText as="div">
                <List>
                  <ListItem>
                    ...
                    as my text editor, with the Atom One Dark theme.
                  </ListItem>
                  <ListItem>
                    <Link href="https://opera.com/">Opera</Link> is my main browser for
                    both development and general use.
                  </ListItem>
                  <ListItem>
                  ...
                  <ListItem>
                    For CSS I’ve used Bootstrap and{' '}
                    <Link href="https://scss.com/">SASS</Link>.
                  </ListItem>
                  <ListItem>
              ...
              <Table>
                <TableBody>
                  <TableRow>
                    ...
                    <TableCell>i7 10th Gen</TableCell>
                  </TableRow>
                  <TableRow>
                    <TableHeadCell>GPU</TableHeadCell>
                    <TableCell>Nvidia Geforce 1650Ti</TableCell>
                  </TableRow>
                  <TableRow>
                    <TableHeadCell>Memory</TableHeadCell>
                    <TableCell>16GB 3200Hz</TableCell>
                  </TableRow>
                  <TableRow>
                  ...
                  <TableRow>
                    ...
                    <TableCell>Dell XPS 9500</TableCell>
                  </TableRow>
                  <TableRow>
                    <TableHeadCell>Earphones</TableHeadCell>
                    <TableCell>One Plus Buds</TableCell>
                  </TableRow>
                </TableBody>
              </Table>
            </ProjectTextRow>
